...
def perform_fuzzy_logic(
    ...
    temperature_membership = {
        "normal": fuzz.interp_membership(
            x_temperature, mem_normal_temperature, temperature
        ),
        "light_fever": fuzz.interp_membership(
            x_temperature, mem_light_fever_temperature, temperature
        ),
        "high_fever": fuzz.interp_membership(
            x_temperature, mem_high_fever_temperature, temperature
        ),
    }
    ...
    musclejointpain_membership = {
        "low": fuzz.interp_membership(
            x_musclejointpain, musclejointpain_low_degree, musclejointpain
        ),
        "medium": fuzz.interp_membership(
            x_musclejointpain, musclejointpain_medium_degree, musclejointpain
        ),
        "severe": fuzz.interp_membership(
            x_musclejointpain, musclejointpain_severe_degree, musclejointpain
        ),
    }
    ...
    swollenglands_membership = {
        "yes": fuzz.interp_membership(
            x_swollenglands, mem_yes_swollenglands, swollenglands
        ),
        "no": fuzz.interp_membership(
            x_swollenglands, mem_no_swollenglands, swollenglands
        ),
    }
    ...
    rule2 = np.fmin(
        np.fmin(eyepain_membership["low"], nausea_membership["low"]), risk_not
    )
    rule3 = np.fmin(
        np.fmin(
            np.fmin(temperature_membership["normal"], headache_membership["mild"]),
    ...
    rule4 = np.fmin(
        np.fmin(
            np.fmin(temperature_membership["light_fever"], headache_membership["mild"]),
            musclejointpain_membership["low"],
        ),
        risk_low,
    )
    rule5 = np.fmin(
        np.fmin(
            np.fmin(
                temperature_membership["light_fever"], headache_membership["medium"]
            ),
            swollenglands_membership["yes"],
        ),
        risk_moderate,
    )
    rule6 = np.fmin(
        np.fmin(
            temperature_membership["light_fever"], musclejointpain_membership["medium"]
        ),
        risk_moderate,
    )
    rule7 = np.fmin(
        np.fmin(
            np.fmin(temperature_membership["light_fever"], vomiting_membership["yes"]),
            rash_membership["yes"],
        ),
        risk_high,
    )
    ...
    rule9 = np.fmin(
        np.fmin(
            np.fmin(
                temperature_membership["light_fever"], headache_membership["severe"]
            ),
    ...
    rule10 = np.fmin(
        np.fmin(temperature_membership["normal"], nausea_membership["severe"]), risk_low
    )
    rule11 = np.fmin(
        np.fmin(temperature_membership["normal"], eyepain_membership["medium"]),
        risk_not,
    )
    rule12 = np.fmin(
        np.fmin(
    ...
    rule14 = np.fmin(
        np.fmin(
            np.fmin(
                temperature_membership["high_fever"], headache_membership["severe"]
            ),
            eyepain_membership["severe"],
        ),
        risk_veryHigh,
    )
    rule15 = np.fmin(
        np.fmin(
            np.fmin(
                temperature_membership["high_fever"],
    ...
    rule17 = np.fmin(
        np.fmin(
            np.fmin(temperature_membership["normal"], nausea_membership["low"]),
            swollenglands_membership["yes"],
        ),
        risk_low,
    )
    rule18 = np.fmin(
        np.fmin(
            np.fmin(
                headache_membership["severe"], musclejointpain_membership["severe"]
            ),
            vomiting_membership["yes"],
        ),
        risk_veryHigh,
    ...
    rule19 = np.fmin(
        np.fmin(
            np.fmin(eyepain_membership["severe"], nausea_membership["severe"]),
            swollenglands_membership["yes"],
        ),
        risk_veryHigh,
    )
    ...
    rule25 = np.fmin(
        np.fmin(
            np.fmin(
                np.fmin(
                    np.fmin(
                        temperature_membership["normal"], headache_membership["severe"]
                    ),
                    eyepain_membership["medium"],
                ),
                musclejointpain_membership["medium"],
    ...
    rule29 = np.fmin(
        np.fmin(
            np.fmin(
                temperature_membership["normal"], musclejointpain_membership["low"]
            ),
            swollenglands_membership["yes"],
        ),
        risk_not,
    ...
    rule30 = np.fmin(
        np.fmin(
            np.fmin(
                temperature_membership["normal"], musclejointpain_membership["medium"]
            ),
            rash_membership["yes"],
        ),
        risk_not,
        ...
        np.fmax(
            np.fmax(
                np.fmax(
                    np.fmax(
                        np.fmax(
                            np.fmax(np.fmax(np.fmax(rule7, rule13), rule26), rule28),
                            rule33,
                        ),
                        rule35,
                    ),
                        ...
                        np.fmax(
                            np.fmax(
                                np.fmax(
                                    np.fmax(
                                        np.fmax(
                                            np.fmax(np.fmax(rule14, rule15), rule18),
                                            rule19,
                                        ),
                                        rule20,
                                    ),
    ...
    out_risk = np.fmax(
        np.fmax(np.fmax(np.fmax(out_not, out_low), out_moderate), out_high),
        out_veryHigh,
    )
